...
function SubmitNewQueue({ patients, patientId, setPatientId, services, submitQueue, setServiceId, setServiceName, serviceId, isPriority, setIsPriority }: SubmitNewQueueProps) {
